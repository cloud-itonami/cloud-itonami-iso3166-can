# cloud-itonami-iso3166-can

Open ISO 3166 Blueprint for **CAN**: Canada.
...
tax registration, and local-content rules in Canada, so the operator
...
- **Not the government of Canada.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Canadian-licensed counsel
...
(ISO 3166 `CAN`). Required capabilities:
